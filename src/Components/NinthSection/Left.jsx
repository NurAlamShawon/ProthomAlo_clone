...
const Left = () => {
  return (
    <div className="border-1 border-gray-600 p-7 xl:mx-0 mx-4 relative xl:mb-0 mb-4" >
     <p className="absolute -left-5 top-5 text-xl text-white font-bold hover:text-[#ffb300] cursor-pointer space-y-1">
  <span className="block text-[#ffb300] bg-[#001246] p-1">
    মাইলস্টোন স্কুল ট্র্যাজেডি
    <span className="mx-2 inline-block w-1.5 h-1.5 bg-[#ffb300] rounded-full align-middle"></span>
  </span>
  
  <span className="block bg-[#001246] p-1">
    চিকিৎসায় যেন কোনো
  </span>

  <span className=" inline-block bg-[#001246] p-1">
    অবহেলা না হয়
  </span>
</p>
