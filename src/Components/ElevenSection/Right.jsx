        ...
        <div className="col-span-3">
          <div className="pr-4 space-y-3 border-r-2 border-gray-400">
            ...
            <p className="text-base text-gray-600 hover:text-gray-900">
             ছিপছিপে কায়া, ডাগর ডাগর চোখ আর লম্বা চুলে পাওলির সৌন্দর্য দেখে বারবার মুগ্ধ হন অনুরাগীরা। সম্প্রতি অভিনেত্রী ধরা দিয়েছেন নীল শাড়ির মোহময়ী লুকে।
            </p>
        ...
        <div className="col-span-3">
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">১৫ ঘণ্টা আগে</p>
              </div>
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="space-y-3">
                <p className="text-base font-bold text-gray-800 ">
                 ইন্ডিয়া কতুর উইক ২০২৫: রূপকথার জলপরির মতো র‍্যাম্পে তামান্না ভাটিয়া
                </p>
                <p className="text-sm text-gray-600">২০ ঘণ্টা আগে</p>
              </div>
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="space-y-3">
                <p className="text-base font-bold text-gray-800 ">
                 সুঘ্রাণে মাতিয়ে তুলুন ঘরের কোণ, একটু পেলেই বহুগুণে ফিরিয়ে দেয় এই গাছ
                </p>
                <p className="text-sm text-gray-600">২৪ জুলাই ২০২৫</p>
              </div>
