  ...
  return (
    <div className="pl-4">
      <div className="grid grid-cols-9 ">
        {/* col-span-6 */}
        <div className="xl:col-span-6 col-span-9 xl:pr-4 xl:border-r-2  border-gray-300">
          <div className="relative">
            ...
            <div className="absolute bottom-4 px-4 z-10">
              <p className="text-2xl font-bold text-white">
                হাসপাতাল থেকে ফিরে স্পেনকে ফাইনালে তুললেন
                <br /> বোনমাতি
              </p>
          ...
          <div className="grid grid-cols-2">
            <div className="pr-4 xl:pb-4  border-r-2 border-gray-300">
              <img
                src="https://i.postimg.cc/25n30BKY/image.png"
                alt=""
                className="w-full"
              />
            ...
            <div className=" pl-4 xl:pb-4">
              <img
                src="https://i.postimg.cc/7Y7gFbcB/image.png"
                alt=""
                className="w-full"
              />
              <p className="text-base text-gray-600 hover:text-blue-700">
                এমএলএস অল-স্টার ম্যাচে না খেলায় কি নিষিদ্ধ হবেন মেসি
              </p>
        ...
        {/* col-span-3 */}
        <div className="xl:col-span-3 col-span-9 xl:pl-4">
          <img
            src="https://i.postimg.cc/gkFnCs3h/image.png"
            alt=""
            className="pl-0 xl:mt-0 mt-6 "
          />
          <hr className="border-1 my-6 border-gray-200"></hr>
          {/* first */}
          <div className="space-y-3 my-6">
            ...
            <p className="text-sm text-gray-400 hover:text-blue-700">
              ৪ ঘণ্টা আগে
            </p>
          </div>
          <hr className="border-1 my-6 border-gray-200"></hr>
