  ...
  return (
    <div className="pr-4 space-y-3 border-r-2 border-gray-400 pb-20">
      ...
      <p className="text-base text-gray-600 hover:text-gray-900">
        হলিউডের অ্যাকশন তারকা ব্রুস উইলিস বর্তমানে ডিমেনশিয়ায় ভুগছেন। ২০২২ সালে
        এফেজিয়া রোগ ধরা পড়ার পর থেকেই তাঁর স্বাস্থ্য ক্রমাগত অবনতি হতে থাকে।
      </p>
      <p className="text-base text-gray-600">২১ মিনিট আগে</p>
    </div>
  );
};
